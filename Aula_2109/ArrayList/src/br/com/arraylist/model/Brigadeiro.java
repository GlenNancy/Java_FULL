...
public class Brigadeiro {
	...
	private String apelidoBrigadeiro;
	...
	public String getApelidoBrigadeiro() {
		return apelidoBrigadeiro;
	}
	public void setApelidoBrigadeiro(String apelidoBrigadeiro) {
		this.apelidoBrigadeiro = apelidoBrigadeiro;
	}
